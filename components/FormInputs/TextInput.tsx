      ...
      <div className="mt-2">
        <div className="relative rounded-md ">
          ...
          <input
            ...
            className={cn(
              "block w-full px-4 rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-950 sm:text-sm sm:leading-6 text-sm",
              (errors[`${name}`] && "focus:ring-blue-950 pl-8") ||
                (icon && "pl-8")
            )}
