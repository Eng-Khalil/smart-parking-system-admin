      ...
      <DialogContent className="max-w-md">
        ...
        <div className="bg-emerald-50 dark:bg-emerald-950/30 rounded-lg p-4 text-center mb-4">
          ...
          <h2 className="text-2xl font-bold text-emerald-700 dark:text-emerald-300">
            UGX {withdraw.amount.toLocaleString()}
          </h2>
        </div>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-medium">{getNormalDate(new Date(withdraw.createdAt))}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-2 mt-4">
          <div className="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-1">
            ...
            Transaction ID: {withdraw.id.substring(0, 8)}...
          </div>
        </div>
      </DialogContent>
    </Dialog>
